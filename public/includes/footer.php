...
function renderFooter(): void
{
    ...
    echo '<img src="https://hitmedia.com.au/wp-content/uploads/2024/02/Logo-White-300x63.png" alt="HIT Media" style="max-height:56px; width:auto; display:inline-block;">';
    echo '</div>';
