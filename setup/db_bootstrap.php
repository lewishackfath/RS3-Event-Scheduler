...
if (!tableExists($pdo, 'clan_events')) {
    ...
    $requiredColumns = [
        ...
        'event_start_utc' => 'ALTER TABLE clan_events ADD COLUMN event_start_utc DATETIME NOT NULL AFTER host_name',
        ...
        'created_at_utc' => 'ALTER TABLE clan_events ADD COLUMN created_at_utc DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER is_active',
