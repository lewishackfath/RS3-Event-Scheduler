...
function runDatabaseBootstrap(bool $verbose = false): void
{
    ...
    if (!tableExists($pdo, 'clan_events')) {
        ...
        $requiredColumns = [
            ...
            'recurrence_interval' => 'ALTER TABLE clan_events ADD COLUMN recurrence_interval INT UNSIGNED NOT NULL DEFAULT 1 AFTER recurring_until_utc',
            'recurrence_unit' => 'ALTER TABLE clan_events ADD COLUMN recurrence_unit VARCHAR(10) NOT NULL DEFAULT "weeks" AFTER recurrence_interval',
            'recurring_series_id' => 'ALTER TABLE clan_events ADD COLUMN recurring_series_id VARCHAR(64) NULL AFTER recurrence_unit',
            ...
            'discord_daily_sync_hash' => 'ALTER TABLE clan_events ADD COLUMN discord_daily_sync_hash VARCHAR(64) NULL AFTER discord_daily_posted_at_utc',
            'discord_scheduled_event_id' => 'ALTER TABLE clan_events ADD COLUMN discord_scheduled_event_id VARCHAR(32) NULL AFTER discord_daily_sync_hash',
            ...
            'discord_scheduled_event_sync_hash' => 'ALTER TABLE clan_events ADD COLUMN discord_scheduled_event_sync_hash VARCHAR(64) NULL AFTER discord_scheduled_event_created_at_utc',
            'create_voice_chat_for_event' => 'ALTER TABLE clan_events ADD COLUMN create_voice_chat_for_event TINYINT(1) NOT NULL DEFAULT 0 AFTER discord_scheduled_event_sync_hash',
    ...
    if (!tableExists($pdo, 'discord_weekly_posts')) {
        $pdo->exec(
            'CREATE TABLE discord_weekly_posts (
                ...
                discord_summary_sync_hash VARCHAR(64) NULL,
                discord_gallery_message_id VARCHAR(32) NULL,
                discord_gallery_sync_hash VARCHAR(64) NULL,
        ...
        $requiredColumns = [
            ...
            'discord_summary_sync_hash' => 'ALTER TABLE discord_weekly_posts ADD COLUMN discord_summary_sync_hash VARCHAR(64) NULL AFTER discord_message_id',
            'discord_gallery_message_id' => 'ALTER TABLE discord_weekly_posts ADD COLUMN discord_gallery_message_id VARCHAR(32) NULL AFTER discord_summary_sync_hash',
            'discord_gallery_sync_hash' => 'ALTER TABLE discord_weekly_posts ADD COLUMN discord_gallery_sync_hash VARCHAR(64) NULL AFTER discord_gallery_message_id',
            'discord_gallery_updated_at_utc' => 'ALTER TABLE discord_weekly_posts ADD COLUMN discord_gallery_updated_at_utc DATETIME NULL AFTER discord_gallery_sync_hash',
